...
int main ()
{
    ...
    cout << "Gra: Snake z sama glowa" << endl;
...
if (krzysiugdziejestes1==jabko2 && krzysiugdziejestes2==jabko3 || krzysiugdziejestes1==jabko3 && krzysiugdziejestes2==jabko2){
    ...
    while (licznikpunktow!=10);
    if (przegranalubwygrana==2){
        cout << "Przegrales, waz nie zyje" << endl;
    }
    else if (licznikpunktow==10)
        cout << "Wygrales, twoje punkty to " << licznikpunktow << endl;
